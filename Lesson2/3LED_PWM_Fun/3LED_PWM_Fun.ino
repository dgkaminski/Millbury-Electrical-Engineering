...
void loop() {
  ...
  for (int i = 0; i < MAX_PWM; i = i + 1) {
    analogWrite(LED_1, i);  //Sets the 1st LED brightness to the current value of i
    analogWrite(LED_2, i);  //Sets the 2nd LED brightness to the current value of i
    analogWrite(LED_3, i);  //Sets the 3rd LED brightness to the current value of i
    delay(delay_time);      //Has a delay of length "delay_time" in millisecond between brightness changes
  }
